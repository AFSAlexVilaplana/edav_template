...
print(dbutils.widgets.get("database"))
databaseFolder = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "databaseFolder", debugValue = dbutils.widgets.get("databaseFolder"))
...
#         self.__database = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "database", debugValue = dbutils.widgets.get("database"))
#         self.__databaseFolder = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "databaseFolder", debugValue = dbutils.widgets.get("databaseFolder"))
#         self.__sourceName = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "sourceName", debugValue = dbutils.widgets.get("sourceName"))
#         self.__readFilePath = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "readFilePath", debugValue = dbutils.widgets.get("readFilePath").strip())
...
#         self.__fileExt = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "fileExt", debugValue = dbutils.widgets.get("fileExt"))
#         self.__destTablePrefix = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "destTablePrefix", debugValue = dbutils.widgets.get("destTablePrefix"))
#         self.__loadType = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "loadType", debugValue = dbutils.widgets.get("loadType"))
#         self.__dropColumns = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "dropColumns",debugValue= dbutils.widgets.get("dropColumns"))
#         self.__identityColumns = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "identityColumns",debugValue= dbutils.widgets.get("identityColumns"))
...
#         self.__silverCustomNotebookPath = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "silverCustomNotebookPath",debugValue= dbutils.widgets.get("silverCustomNotebookPath"))
#         self.__goldCustomNotebookPath = dbutils.jobs.taskValues.get(taskKey = setupTaskKey,key = "goldCustomNotebookPath",debugValue= dbutils.widgets.get("goldCustomNotebookPath"))
